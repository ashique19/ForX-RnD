...
def test_streamlit_app_renders_sample_artifacts(monkeypatch):
    ...
    assert "fx-legend" in joined or "fx-empty" in joined or "fx-chip buy" in joined
    assert "stDeployButton" in joined or "fx-badge-stale" in joined or "fx-kicker" in joined
